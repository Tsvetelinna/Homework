...
int main()
{
	int num;
	int numberofzeros;
	int bin[21]; //Числото един милион в двуичен запис съдържа 20 позиции, от което следва, че няма да се събере в числен тип. Затова ще използвам масив от 20 елемента.
	int count = 0;
	int maxzeros = 0;
	int current = 0;
